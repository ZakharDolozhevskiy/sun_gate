 ...
 */
function genderIndicator (websocket) {
  ws = websocket;
...
/**
 * Send latest data from Gender generator to client by websocket.
...
module.exports = genderIndicator;
