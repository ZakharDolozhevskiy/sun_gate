 ...
 */
function secondsIndicator (websocket) {
  ws = websocket;
...
/**
 * Send latest data from Seconds generator to client by websocket.
...
module.exports = secondsIndicator;
