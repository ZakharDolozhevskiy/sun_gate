 ...
 */
var rangyCreate = function(global){
    var window = global;
    ...
    window['rangy'].createModule("DomUtil", function(api, module) {
    ...
    });window['rangy'].createModule("DomRange", function(api, module) {
    ...
    window['rangy'].createModule("WrappedRange", function(api, module) {
    ...
    });window['rangy'].createModule("WrappedSelection", function(api, module) {
    ...
    window['rangy'].createModule("CssClassApplier", function(api, module) {
